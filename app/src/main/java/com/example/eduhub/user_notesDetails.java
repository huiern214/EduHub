...
import java.util.Objects;
 ...
 public class user_notesDetails extends AppCompatActivity {
    ...
    @@ -97,9 +109,9 @@ protected void onCreate(Bundle savedInstanceState) {
    ...
    @@ -115,22 +127,6 @@ protected void onCreate(Bundle savedInstanceState) {
    ...
    @@ -236,6 +232,12 @@ public void onClick(View v) {
    ...
    @@ -261,31 +263,10 @@ public void onClick(View v) {
    ...
    @@ -295,144 +276,6 @@ public void onClick(View v) {
    ...
    @@ -508,8 +351,7 @@ private void addReportFirebase(String reportDetails) {
    ...
    @@ -556,7 +398,7 @@ private void loadComments(String noteId) {
    ...
    @@ -623,7 +465,7 @@ private void addCommentFirebase(String comment) {
    ...
    @@ -640,7 +482,7 @@ private void addCommentFirebase(String comment) {
    ...
    @@ -678,6 +520,7 @@ private void downloadPdf(String url) {
    ...
    @@ -687,8 +530,6 @@ private void loadNoteDetails(String noteId) {
    ...
    @@ -711,14 +552,6 @@ private void loadNoteDetails(String noteId) {
